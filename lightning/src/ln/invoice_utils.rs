...
>(
	...
	min_final_cltv_expiry_delta: Option<u16>, contract_id: Option<ContractId>,
	amt_rgb: Option<u64>,
) -> Result<Bolt11Invoice, SignOrCreationError<()>>
where
...
>(
	...
	contract_id: Option<ContractId>, amt_rgb: Option<u64>,
) -> Result<Bolt11Invoice, SignOrCreationError<()>>
where
	M::Target: chain::Watch<<SP::Target as SignerProvider>::EcdsaSigner>,
	T::Target: BroadcasterInterface,
...
mod test {
	...
	fn test_create_invoice_with_description_hash() {
		...
		assert_eq!(
			invoice.description(),
			Bolt11InvoiceDescription::Hash(&Sha256(Sha256::hash(
