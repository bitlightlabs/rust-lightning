...
impl Writeable for ChannelUpdateInfo {
	fn write<W: crate::util::ser::Writer>(&self, writer: &mut W) -> Result<(), io::Error> {
		write_tlv_fields!(writer, {
			...
			(12, self.last_update_message, required),(14, self.htlc_maximum_rgb, required),
...
impl Readable for ChannelUpdateInfo {
	fn read<R: io::Read>(reader: &mut R) -> Result<Self, DecodeError> {_init_tlv_field_var!(htlc_maximum_rgb, required);
		...
		read_tlv_fields!(reader, {
			...
			(10, fees, required),
			(12, last_update_message, required),(14, htlc_maximum_rgb, required)
...
impl Writeable for ChannelInfo {
	fn write<W: crate::util::ser::Writer>(&self, writer: &mut W) -> Result<(), io::Error> {
		write_tlv_fields!(writer, {
			...
			(12, self.announcement_message, required),(14, self.contract_id, option),
...
impl Readable for ChannelInfo {
	fn read<R: io::Read>(reader: &mut R) -> Result<Self, DecodeError> {
		...
		read_tlv_fields!(reader, {
			...
			(12, announcement_message, required),(14, contract_id, option),
